    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../../index.php">
                ...
                <div class="sidebar-brand-text mx-3">E-Learn</div>
            </a>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="rounded" src="https://source.unsplash.com/pAtA8xe_iVM/32x32">
                            </a>
                ...
                <div class="container-fluid d-flex align-items-center justify-content-center" style="height: 70vh">
                    <div class="text-center">
                        ...
                        <p class="text-gray-500 my3">Halaman tidak tersedia!</p>
                        <a href="../../auth/login.php" class="btn bg-primary text-light btn-icon-split" id="modal-trigger">
